...
imp.data <- loadMethQTL(system.file("extdata/reduced_methQTL",package="MAGAR"))
qtlSetOption(standard.deviation.gauss=100,
	cluster.cor.threshold=0.75)
meth.qtl.res <- doMethQTL(imp.data,default.options=F,p.val.cutoff=0.05)
```
